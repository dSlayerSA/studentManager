...
export default {
  ...
  methods: {
    //student list
    getStudents() {
      axios.get('http://ec2-3-134-108-53.us-east-2.compute.amazonaws.com:8000/api/students')
        .then(response => {
    ...
    show() {
      ...
      axios.get("http://ec2-3-134-108-53.us-east-2.compute.amazonaws.com:8000/api/students/show", { params: params })
        .then((response) => {
    ...
    addStudent() {
      ...
      axios.post('http://ec2-3-134-108-53.us-east-2.compute.amazonaws.com:8000/api/students/store', formData)
        .then(response => {
    ...
    saveStudentEdit() {
      ...
      if (editTrue) {
        axios.put(`http://ec2-3-134-108-53.us-east-2.compute.amazonaws.com:8000/api/students/${mainStudent.AR}`, editedStudent)
          .then(response => {
            console.log(response.data);
    ...
    deleteStudent(AR) {
      ...
      if (confirmar) {
        axios.delete(`http://ec2-3-134-108-53.us-east-2.compute.amazonaws.com:8000/api/students/${AR}`)
          .then(response => {
            console.log(response.data);
